            ...
            const enrichedRepos = await Promise.all(repos.map(async (repo) => {
                ...
                try {
                    ...
                    if (languagesResponse.data &&
                        ...
                        const langMap = languagesResponse.data;
                        const total = Object.values(langMap).reduce((sum, bytes) => sum + bytes, 0);
                        languages = Object.entries(langMap).reduce((acc, [lang, bytes]) => {
                ...
                return {
                    ...
                    stars: typeof repo.stargazers_count === 'number'
                        ? repo.stargazers_count
                        : 0,
                    forks: typeof repo.forks_count === 'number' ? repo.forks_count : 0,
                    watchers: typeof repo.watchers_count === 'number' ? repo.watchers_count : 0,
                    openIssues: typeof repo.open_issues_count === 'number'
