...
__decorate([
    (0, swagger_1.ApiPropertyOptional)({ example: 'https://www.linkedin.com/in/username/', description: 'Lien profil LinkedIn (utilisé pour enrichir les compétences via Apify)' }),
    (0, class_validator_1.IsOptional)(),
    (0, class_transformer_1.Transform)(({ value }) => (typeof value === 'string' && value.trim() === '' ? undefined : value)),
    (0, class_validator_1.IsString)(),
    (0, class_validator_1.MaxLength)(2048),
