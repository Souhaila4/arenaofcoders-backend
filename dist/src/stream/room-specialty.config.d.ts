...
export declare const GENERAL_MEMBER_ROOM_ID = "room-general";
...
export declare function canAccessRoom(roomId: string, _mainSpecialty: Specialty | null): boolean;
export interface RoomWithAccess extends RoomInfo {
    specialty?: Specialty | null;
    canParticipate: boolean;
}
export declare function getRoomsForSpecialty(_mainSpecialty: Specialty | null): RoomInfo[];
export declare function getAllRoomsWithAccess(_mainSpecialty: Specialty | null): RoomWithAccess[];
