...
export class CompetitionService {
  ...
  async submitCheckpoint(
    ...
    if (participation.equipeId) {
      ...
      // On met à jour tous les membres de l'équipe d'un coup
      ...
      // On retourne la soumission du leader pour satisfaire le type de retour
      return this.prisma.checkpointSubmission.findUnique({
