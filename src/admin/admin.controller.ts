...
import { ApiBearerAuth, ApiOperation, ApiQuery, ApiResponse, ApiTags, ApiParam, ApiBody } from '@nestjs/swagger';
...
export class AdminController {
  ...
  @ApiBody({ schema: { type: 'object', properties: { role: { type: 'string', enum: ['USER', 'ADMIN', 'COMPANY'] } } } })
  ...
  @ApiOperation({ summary: 'Liste les demandes du rôle entreprise (Admin only)' })
  ...
  @ApiOperation({ summary: 'Accepter ou refuser une demande de rôle entreprise' })
