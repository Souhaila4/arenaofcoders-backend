...
export class AntiCheatController {
  ...
  private readonly imageSpaceUrl = 'https://negzaoui-antiimagesenvirement.hf.space/scan';
  private readonly audioSpaceUrl = 'https://negzaoui-modelevocal.hf.space/scan-audio';
  ...
  @ApiOperation({ summary: 'Proxy — Workspace image anti-cheat validation via HuggingFace Space' })
  async validateImage(
    @UploadedFiles()
  ...
  @ApiConsumes('multipart/form-data')
  @ApiOperation({ summary: 'Proxy — Vocal audio anti-cheat validation via HuggingFace Space' })
  async validateAudio(
