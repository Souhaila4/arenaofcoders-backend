...
export class AuthController {
  ...
  @ApiOperation({
    ...
    description:
      'Sign up with email, password, name, and a .docx resume. CV extraction sets mainSpecialty and skillTags from the resume.',
  })
  @ApiBody({
    schema: {
      type: 'object',
      ...
      properties: {
        ...
        resume: {
          type: 'string',
          format: 'binary',
          description: 'Resume .docx (required, max 5MB)',
        },
        avatar: {
          type: 'string',
          format: 'binary',
  ...
  @ApiResponse({
    status: 400,
    description: 'Validation error or missing/invalid resume/avatar',
  })
