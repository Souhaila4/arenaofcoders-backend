...
Les meilleures idées seront récompensées !`;
    ...
    const competition = await prisma.competition.create({
      data: {
        title: "Hackthon", // As requested "name : Hackthon"
        description: description,
        difficulty: CompetitionDifficulty.MEDIUM,
        specialty: null, // "ne pas faire specialite"
        startDate: startDate,
        endDate: endDate,
